...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser(users.username("john").password("fun123").roles("OWNER"))
                .withUser(users.username("mary").password("fun123").roles("WAITER","CUSTOMER"))
                .withUser(users.username("susan").password("fun123").roles("OWNER","CUSTOMER"));
    }
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        .formLogin()
            .loginPage("/api/login")
            .loginPage("/api6/loginForm")
            .loginPage("/api1/login")
